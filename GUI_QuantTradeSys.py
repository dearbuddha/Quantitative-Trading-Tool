...
class Frame(wx.Frame):
    def __init__(self):
        wx.Frame.__init__(self, parent=None, title=u'Quantitative Trading Tool', size=(1500, 800),
        ...
        paraInput_Box = wx.StaticBox(self.ParaPanel, -1, u'Parameters')
        paraInput_Sizer = wx.StaticBoxSizer(paraInput_Box, wx.VERTICAL)
        self.StNameCodedict = {u"开山股份": "300257.SZ", u"浙大网新": "600797.SS", u"水晶光电": "002273.SZ",
                               u"高鸿股份": "000851.SZ", u"第一创业": "002797.SZ", u"歌尔股份": "002241.SZ",
                               u"大唐电信": "600198.SS", u"沪电股份": "002463.SZ", u"立讯精密": "002475.SZ"}
        ...
        stockCode_Text = wx.StaticText(self.ParaPanel, -1, u'Stocks')

        # 策略选取
        strate_Text = wx.StaticText(self.ParaPanel, -1, u'Strategies')
        ...
        self.dpcEndTime = wx.adv.DatePickerCtrl(self.ParaPanel, -1,
        ...
        RadioList = ["None", "Jump vacancies", "Crossings", "N日突破"]
        self.StratInputBox = wx.RadioBox(self.ParaPanel, -1, label=u'指标提示', choices=RadioList, majorDimension=4,
        ...
        # 行情按钮
        self.Firmoffer = wx.Button(self.CtrlPanel, -1, "Prices")
        self.Firmoffer.Bind(wx.EVT_BUTTON, self.FirmEvent)  # 绑定行情按钮事件
        # 选股按钮
        self.Stockpick = wx.Button(self.CtrlPanel, -1, "Screen")
        self.Stockpick.Bind(wx.EVT_BUTTON, self.PstockpEvent)  # 绑定选股按钮事件
        # 回测按钮
        self.Backtrace = wx.Button(self.CtrlPanel, -1, "Backtest")
